...
class OptimalcontrolCost(object) :
    ...
    def diff_cost_central(self,x,u):
        # state & input size
        ix = self.ix
        iu = self.iu
        ...
        # numerical difference
        c_change_m = self.estimate_cost(x_aug_m,u_aug_m)
        c_change_p = self.estimate_cost(x_aug_p,u_aug_p)
    ...
    def hess_cost_central(self,x,u):
        ...
        # numerical difference
        c_change_m = self.diff_cost_central(x_aug_m,u_aug_m)
        c_change_p = self.diff_cost_central(x_aug_p,u_aug_p)
